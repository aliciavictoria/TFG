...
if __name__ == "__main__":
    ...
    PUZZLES = [
        ...
        "puzzles/linguini_012018020100.json",  # Hakhun →EN  [YA TENEMOS de ayer]
        "puzzles/linguini_012018020200.json",  # Hakhun EN→  [Sino-Tibetana]

        # ── Puzzles con resultados previos del 8B (relanzar para comparar) ──
    ...
    MODELS_RUN = [
        # "llama-3.1-8b-groq",        # ← mañana (cuota agotada)
        # "llama-3.3-70b-groq",         # ← ACTIVO AHORA
        "gpt-oss-120b-openrouter",  # ← después del 70B
    ]
