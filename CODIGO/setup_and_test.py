...
if __name__ == "__main__":
    ...
    if cerebras_key:
        ...
        print("  ✗ CEREBRAS_API_KEY no configurada")
...
Necesitas al menos una key. Registro gratuito (sin tarjeta):
  ...
  CEREBRAS (14.400 req/día):
    1. https://cloud.cerebras.ai → Sign in → API Keys → Create
    2. export CEREBRAS_API_KEY='csk_...'
...
""")
    ...
    if cerebras_key:
        ok3 = test_api("cerebras",
            "https://api.cerebras.ai/v1/chat/completions",
            cerebras_key, "llama-3.3-70b", "Cerebras / Llama 3.3 70B (fuerte)")
