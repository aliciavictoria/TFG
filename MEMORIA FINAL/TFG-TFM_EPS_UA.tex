% !TeX document-id = {759e4f43-4ef6-4117-86ed-c244b3b27516}
% !TeX program = xelatex
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Resolución de problemas de la Olimpiada Lingüística mediante modelos de lenguaje de gran escala}
\newcommand{\subtitulo}{Aplicación de modelos de inteligencia artificial}
% Datos del autor
\newcommand{\miNombre}{Alicja Wiktoria Hyska}
\newcommand{\miEmail}{awh1@alu.ua.es}
% Datos del tutor/es
\newcommand{\miTutor}{Juan Antonio Pérez Ortiz}
...
\input{capitulos/trabajos_futuros}
