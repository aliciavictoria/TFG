...
\thispagestyle{empty}
\begin{quote}
Este trabajo surge del interés por explorar los límites del razonamiento lingüístico en los modelos de lenguaje actuales. El objetivo es diseñar y evaluar estrategias de prompting que permitan a estos modelos resolver puzzles de olimpiadas lingüísticas a partir de un conjunto reducido de ejemplos y sin recibir información explícita previa sobre la lengua analizada. El trabajo se enmarca en el área de procesamiento de lenguas de baja densidad de recursos y ha sido realizado bajo la supervisión del profesor Juan Antonio Pérez Ortiz en el Grado de Ingeniería Informática de la Universidad de Alicante.
\end{quote}
